...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, EntityManagerInterface $entityManager,UserRepository $userRepository,MailerInterface $mailer)
    {
     ...
     *
     * @Route("", name="forgot_password", priority="3")
     */
    ...
    private function processSendingPasswordResetEmail(string $emailFormData,  TranslatorInterface $translator): RedirectResponse
    {
        ...
        $email->from(new Address('noreply@commerce.com', 'Ecommerce'))
            ->to($user->getEmail())
